...
学霸帝Code 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://xuebadi-code.ai/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://xuebadi-code.ai/docs)。
...
如果你在项目名中使用了 “opencode”（如 “opencode-dashboard” 或 “opencode-mobile”），请在 README 里注明该项目不是 学霸帝Code 团队官方开发，且不存在隶属关系。
