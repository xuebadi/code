...
<p align="center">学霸帝Code je open source AI agent za programiranje.</p>
<p align="center">
...
学霸帝Code uključuje dva ugrađena agenta između kojih možeš prebacivati tasterom `Tab`.
...
Saznaj više o [agentima](https://xuebadi-code.ai/docs/agents).

### Dokumentacija

Za više informacija o konfiguraciji 学霸帝Code-a, [**pogledaj dokumentaciju**](https://xuebadi-code.ai/docs).

### Doprinosi

Ako želiš doprinositi 学霸帝Code-u, pročitaj [upute za doprinošenje](./CONTRIBUTING.md) prije slanja pull requesta.

### Gradnja na 学霸帝Code-u

Ako radiš na projektu koji je povezan s 学霸帝Code-om i koristi "opencode" kao dio naziva, npr. "opencode-dashboard" ili "opencode-mobile", dodaj napomenu u svoj README da projekat nije napravio 学霸帝Code tim i da nije povezan s nama.
