...
学霸帝Code bao gồm hai agent được tích hợp sẵn mà bạn có thể chuyển đổi bằng phím `Tab`.
...
Tìm hiểu thêm về [agents](https://xuebadi-code.ai/docs/agents).

### Tài liệu

Để biết thêm thông tin về cách cấu hình 学霸帝Code, [**hãy truy cập tài liệu của chúng tôi**](https://xuebadi-code.ai/docs).

### Đóng góp

Nếu bạn muốn đóng góp cho 学霸帝Code, vui lòng đọc [tài liệu hướng dẫn đóng góp](./CONTRIBUTING.md) trước khi gửi pull request.

### Xây dựng trên nền tảng 学霸帝Code

Nếu bạn đang làm việc trên một dự án liên quan đến 学霸帝Code và sử dụng "opencode" như một phần của tên dự án, ví dụ "opencode-dashboard" hoặc "opencode-mobile", vui lòng thêm một ghi chú vào README của bạn để làm rõ rằng dự án đó không được xây dựng bởi đội ngũ 学霸帝Code và không liên kết với chúng tôi dưới bất kỳ hình thức nào.
