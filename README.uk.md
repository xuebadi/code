...
学霸帝Code містить два вбудовані агенти, між якими можна перемикатися клавішею `Tab`.
...
Дізнайтеся більше про [agents](https://xuebadi-code.ai/docs/agents).

### Документація

Щоб дізнатися більше про налаштування 学霸帝Code, [**перейдіть до нашої документації**](https://xuebadi-code.ai/docs).

### Внесок

Якщо ви хочете зробити внесок в 学霸帝Code, будь ласка, прочитайте нашу [документацію для контриб'юторів](./CONTRIBUTING.md) перед надсиланням pull request.

### Проєкти на базі 学霸帝Code

Якщо ви працюєте над проєктом, пов'язаним з 学霸帝Code, і використовуєте "opencode" у назві, наприклад "opencode-dashboard" або "opencode-mobile", додайте примітку до свого README.
Уточніть, що цей проєкт не створений командою 学霸帝Code і жодним чином не афілійований із нами.
