...
- `学霸帝Code` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `学霸帝Code` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `学霸帝Code` inside commands, URLs, package names, or code literals
