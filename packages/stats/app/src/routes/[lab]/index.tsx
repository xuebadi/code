...
export default function StatsLab() {
  ...
  const labTitle = createMemo(() => `${labName()} AI Model Usage & Rankings | 学霸帝Code Data`)
  const labDescription = createMemo(
    () =>
      `Compare ${labName()} models used in 学霸帝Code Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.`,
  )
    ...
    <section id="overview" data-section="lab-hero">
      <div data-slot="model-hero-grid">
        <div data-slot="model-hero-copy">
          ...
          <h1>Model Lab</h1>
          <p>Reading model availability and recent 学霸帝Code usage.</p>
        </div>
      </div>
    </section>
  )
    ...
    <section id="overview" data-section="lab-hero">
      ...
      <div data-slot="model-hero-grid">
        <div data-slot="model-hero-copy">
          ...
          <p>
            Explore {props.lab.models.length} {props.lab.name} models used in 学霸帝Code
        ...
        <div data-component="model-rank-panel">
          ...
          <p>
            {props.stats
              ? `${formatPercent(props.stats.tokenShare)} of recent 学霸帝Code usage`
              : latest()
  ...
  return (
    <section id="usage" data-section="model-panel">
      <p data-slot="section-title">
        ...
        <span>Daily 学霸帝Code token volume over the last two months.</span>
      </p>
      <Show
