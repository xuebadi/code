...
const appId = channel === "prod" ? "com.xuebadi.code" : `com.xuebadi.code.${channel}`
const productName = channel === "prod" ? "学霸帝Code" : `学霸帝Code ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      学霸帝Code is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
  ...
  <url type="homepage">https://xuebadi-code.ai</url>
