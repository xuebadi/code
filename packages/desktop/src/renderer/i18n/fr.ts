export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'学霸帝Code",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'学霸帝Code a été téléchargée. Voulez-vous l'installer et redémarrer ?",
