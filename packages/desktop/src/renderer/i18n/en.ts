export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of 学霸帝Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of 学霸帝Code has been downloaded, would you like to install it and relaunch?",
