export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von 学霸帝Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von 学霸帝Code wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
