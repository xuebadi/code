export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af 学霸帝Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af 学霸帝Code er blevet downloadet. Vil du installere den og genstarte?",
