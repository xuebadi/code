export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av 学霸帝Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av 学霸帝Code er lastet ned. Vil du installere den og starte på nytt?",
