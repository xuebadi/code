export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do 学霸帝Code",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do 学霸帝Code foi baixada. Você gostaria de instalá-la e reiniciar?",
