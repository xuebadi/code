export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من 学霸帝Code",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من 学霸帝Code، هل ترغب في تثبيته وإعادة تشغيله؟",
