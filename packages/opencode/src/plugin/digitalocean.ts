...
<html>
  <head>
    <meta charset="utf-8" />
    <title>学霸帝Code - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to 学霸帝Code."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. 学霸帝Code will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
