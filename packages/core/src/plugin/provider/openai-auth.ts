...
const successPage =
  "<!doctype html><title>学霸帝Code</title><h1>Authorization successful</h1><p>You can close this window.</p>"
const errorPage = (message: string) =>
  `<!doctype html><title>学霸帝Code</title><h1>Authorization failed</h1><p>${message.replace(/[&<>"']/g, "")}</p>`
