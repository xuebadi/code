...
import { AbsolutePath, Location, Model, 学霸帝Code, Session, Tool } from "@opencode-ai/core/public"
import { tmpdir } from "./fixture/tmpdir"
import { testEffect } from "./lib/effect"

const it = testEffect(学霸帝Code.layer)

describe("public native 学霸帝Code API", () => {
  it.effect("exposes only the intentional Session capabilities", () =>
    Effect.gen(function* () {
      const opencode = yield* 学霸帝Code.Service
