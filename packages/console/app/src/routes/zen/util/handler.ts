...
export async function handler(
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://xuebadi-code.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://xuebadi-code.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://xuebadi-code.ai/workspace/${authInfo.workspaceID}/members`
