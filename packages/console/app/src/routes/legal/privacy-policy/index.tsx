...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>学霸帝Code | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="学霸帝Code privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At 学霸帝Code, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of 学霸帝Code is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://xuebadi-code.ai/legal/terms-of-service</a>,
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the 学霸帝Code website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about 学霸帝Code.
                </li>
              ...
              <p>
                ...
                you, 学霸帝Code or another party; enforcing any agreements with you; responding to claims that any posting
