...
export const dict = {
  ...
  "notFound.title": "페이지를 찾을 수 없음 | 学霸帝Code",
  ...
  "app.meta.description": "学霸帝Code - 오픈 소스 코딩 에이전트.",

  "home.title": "学霸帝Code | 오픈 소스 AI 코딩 에이전트",

  "temp.title": "学霸帝Code | 터미널을 위해 만들어진 AI 코딩 에이전트",
  ...
  "temp.screenshot.caption": "tokyonight 테마가 적용된 学霸帝Code TUI",
  "temp.screenshot.alt": "tokyonight 테마가 적용된 学霸帝Code TUI",
  ...
  "zen.title": "学霸帝Code Zen | 코딩 에이전트를 위한 신뢰할 수 있고 최적화된 모델 세트",
  ...
  "zen.faq.q1": "学霸帝Code Zen이란 무엇인가요?",
  "zen.faq.a1": "Zen은 学霸帝Code 팀이 코딩 에이전트를 위해 테스트하고 벤치마킹한 엄선된 AI 모델 세트입니다.",
  ...
  "zen.problem.subtitle": "우리는 学霸帝Code 사용자뿐만 아니라 모든 분들을 위해 이 문제를 해결하고 있습니다.",
  ...
  "go.title": "学霸帝Code Go | 모두를 위한 저비용 코딩 모델",
  ...
  "go.problem.body":
    "우리는 가능한 많은 사람들에게 学霸帝Code 경험을 제공하는 데 집중하고 있습니다. 学霸帝Code Go는 저렴한 구독 서비스로, 첫 달 $5, 이후 $10/월입니다. 넉넉한 한도와 가장 뛰어난 오픈 소스 모델에 대한 안정적인 액세스를 제공합니다.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go는 첫 달 $5, 이후 $10/월로 시작합니다. 学霸帝Code 또는 어떤 에이전트와도 함께 사용할 수 있습니다.",
  ...
  "zen.api.error.trialEnded":
    "{{model}}의 무료 프로모션이 종료되었습니다. 学霸帝Code Go를 구독하면 모델을 계속 사용할 수 있습니다 - {{link}}",

  "black.meta.title": "学霸帝Code Black | 세계 최고의 코딩 모델에 액세스하세요",
  "black.meta.description": "学霸帝Code Black 구독 플랜으로 Claude, GPT, Gemini 등에 액세스하세요.",
  "black.hero.title": "세계 최고의 코딩 모델에 액세스하세요",
  "black.hero.subtitle": "Claude, GPT, Gemini 등 포함",
  "black.title": "学霸帝Code Black | 가격",
  ...
  "black.workspace.title": "学霸帝Code Black | 워크스페이스 선택",
  "black.workspace.selectPlan": "이 플랜을 사용할 워크스페이스를 선택하세요",
  "black.workspace.name": "워크스페이스 {{n}}",
  "black.subscribe.title": "学霸帝Code Black 구독하기",
  ...
  "black.subscribe.success.title": "学霸帝Code Black 대기 명단에 등록되었습니다",
  ...
  "workspace.newUser.step.login.after": "후 学霸帝Code 선택",
  ...
  "workspace.keys.subtitle": "学霸帝Code 서비스 액세스를 위한 API 키를 관리하세요.",
  "workspace.keys.create": "API 키 생성",
  "workspace.keys.placeholder": "키 이름 입력",
  "workspace.keys.empty": "学霸帝Code 게이트웨이 API 키 생성",
  ...
  "workspace.black.subscription.message": "현재 월 ${{plan}} 学霸帝Code Black 플랜을 구독 중입니다.",
  ...
  "workspace.black.waitlist.joined": "월 ${{plan}} 学霸帝Code Black 플랜 대기 명단에 등록되었습니다.",
  "workspace.black.waitlist.ready": "월 ${{plan}} 学霸帝Code Black 플랜에 등록할 준비가 되었습니다.",
  ...
  "workspace.lite.subscription.message": "현재 学霸帝Code Go를 구독 중입니다.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go 모델을 사용하려면 opencode 설정에서 "学霸帝Code Go"를 공급자로 선택하세요.',
  "workspace.lite.black.message":
    "현재 学霸帝Code Black을 구독 중이거나 대기 명단에 등록되어 있습니다. Go로 전환하려면 먼저 구독을 취소해 주세요.",
  "workspace.lite.other.message":
    "이 워크스페이스의 다른 멤버가 이미 学霸帝Code Go를 구독 중입니다. 워크스페이스당 한 명의 멤버만 구독할 수 있습니다.",
  "workspace.lite.promo.description":
    "学霸帝Code Go는 {{price}}부터 시작하며, 이후 $10/월로 넉넉한 사용량 한도와 함께 인기 있는 오픈 코딩 모델에 대한 안정적인 액세스를 제공합니다.",
  ...
  "download.title": "学霸帝Code | 다운로드",
  "download.meta.description": "macOS, Windows, Linux용 学霸帝Code 다운로드",
  "download.hero.title": "学霸帝Code 다운로드",
  "download.hero.subtitle": "macOS, Windows, Linux용 베타 버전 사용 가능",
  "download.hero.button": "{{os}}용 다운로드",
  "download.section.terminal": "学霸帝Code 터미널",
  "download.section.desktop": "学霸帝Code 데스크톱 (베타)",
  "download.section.extensions": "学霸帝Code 확장 프로그램",
  "download.section.integrations": "学霸帝Code 통합",
  ...
  "enterprise.title": "学霸帝Code | 조직을 위한 엔터프라이즈 솔루션",
  "enterprise.meta.description": "学霸帝Code 엔터프라이즈 솔루션 문의",
  ...
  "enterprise.faq.q1": "学霸帝Code 엔터프라이즈란 무엇인가요?",
  "enterprise.faq.a1":
    "学霸帝Code 엔터프라이즈는 코드와 데이터가 인프라 외부로 유출되지 않도록 보장하려는 조직을 위한 솔루션입니다. SSO 및 내부 AI 게이트웨이와 통합되는 중앙 집중식 설정을 통해 이를 구현합니다.",
  "enterprise.faq.q2": "学霸帝Code 엔터프라이즈는 어떻게 시작하나요?",
  "enterprise.faq.a2":
  ...
  "enterprise.faq.q4": "学霸帝Code 엔터프라이즈에서 데이터는 안전한가요?",
  "enterprise.faq.a4":
  ...
  "brand.title": "学霸帝Code | 브랜드",
  "brand.meta.description": "学霸帝Code 브랜드 가이드라인",
  "brand.heading": "브랜드 가이드라인",
  "brand.subtitle": "学霸帝Code 브랜드를 활용하는 데 도움이 되는 리소스와 자산입니다.",
  "brand.downloadAll": "모든 자산 다운로드",

  "changelog.title": "学霸帝Code | 변경 내역",
  "changelog.meta.description": "学霸帝Code 릴리스 노트 및 변경 내역",
