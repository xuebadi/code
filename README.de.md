...
学霸帝Code enthält zwei eingebaute Agents, zwischen denen du mit der `Tab`-Taste wechseln kannst.
...
Mehr dazu unter [Agents](https://xuebadi-code.ai/docs/agents).

### Dokumentation

Mehr Infos zur Konfiguration von 学霸帝Code findest du in unseren [**Docs**](https://xuebadi-code.ai/docs).

### Beitragen

Wenn du zu 学霸帝Code beitragen möchtest, lies bitte unsere [Contributing Docs](./CONTRIBUTING.md), bevor du einen Pull Request einreichst.

### Auf 学霸帝Code aufbauen

Wenn du an einem Projekt arbeitest, das mit 学霸帝Code zusammenhängt und "opencode" als Teil seines Namens verwendet (z.B. "opencode-dashboard" oder "opencode-mobile"), füge bitte einen Hinweis in deine README ein, dass es nicht vom 学霸帝Code-Team gebaut wird und nicht in irgendeiner Weise mit uns verbunden ist.
