<p align="center">
  <a href="https://xuebadi-code.ai">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="Logo 学霸帝Code">
    </picture>
  </a>
</p>
...
学霸帝Code include due agenti integrati tra cui puoi passare usando il tasto `Tab`.
...
Scopri di più sugli [agenti](https://xuebadi-code.ai/docs/agents).

### Documentazione

Per maggiori informazioni su come configurare 学霸帝Code, [**consulta la nostra documentazione**](https://xuebadi-code.ai/docs).

### Contribuire

Se sei interessato a contribuire a 学霸帝Code, leggi la nostra [guida alla contribuzione](./CONTRIBUTING.md) prima di inviare una pull request.

### Costruire su 学霸帝Code

Se stai lavorando a un progetto correlato a 学霸帝Code e che utilizza “opencode” come parte del nome (ad esempio “opencode-dashboard” o “opencode-mobile”), aggiungi una nota nel tuo README per chiarire che non è sviluppato dal team 学霸帝Code e che non è affiliato in alcun modo con noi.
