...
function useShareUrl() {
  return isMock() ? "https://dev.xuebadi-code.ai" : "https://xuebadi-code.ai"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.xuebadi-code.ai/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.xuebadi-code.ai/exchange_github_app_token", {
      method: "POST",
      headers: {
